"""Shared 3D Gaussian projection helpers used by front-ends and backends."""
...
def world_to_camera(camera_to_world: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor]:
...
def project_gaussians_3d_to_2d(
    ...
    rotation_w2c, translation_w2c = world_to_camera(camera_to_world)
